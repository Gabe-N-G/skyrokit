...
router.post('/', async (req, res) => {
  ...
  // controllers/applications.js DELETE ROUTE
...
router.delete('/:applicationId', async (req, res) => {
    ...
    // controllers/applications.js SHOW ROUTE
...
// controllers/applications.js EDIT ROUTE
...
router.get('/:applicationId/edit', async (req, res) => {
  ...
  // controllers/applications.js` UPDATE ROUTE
